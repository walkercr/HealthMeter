...
import honeydo.dao.UserDao;
import honeydo.model.User;
import honeydo.services.IUserService;
import honeydo.services.UserService;
...
public class DBConfig {
    ...
    public SessionFactory sessionFactory() throws IOException {
        ...
        bean.setPackagesToScan("honeydo.model");
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/honeydo");
